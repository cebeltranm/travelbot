...
export const useActivitiesStore = defineStore('activities', () => {
  ...
  const moreInfoCommand = ref('give me more info about this activity, including price, transportation suggestions, links to reservations, and tips in JSON format and generates');
